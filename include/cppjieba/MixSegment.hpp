...
class MixSegment : public SegmentTagged {
 public:
  ...
  void Cut(const string& sentence, vector<string>& words) const { Cut(sentence, words, true); }
  ...
  string LookupTag(const string& str) const { return tagger_.LookupTag(str, *this); }
